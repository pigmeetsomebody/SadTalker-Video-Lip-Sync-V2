...
from src.data_gen.utils.path_converter import PathConverter, pc
...
def extract_img_job(video_name, raw_img_dir=None):
    ...
    cmd = f'ffmpeg -i {video_name} -vf fps={25},scale=w=512:h=512 -qmin 1 -q:v 1 -start_number 0 -v quiet {os.path.join(out_path, "%8d.jpg")}'
    os.system(cmd)
