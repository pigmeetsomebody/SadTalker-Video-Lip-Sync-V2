...
from src.utils.commons.os_utils import multiprocess_glob
import pickle
import traceback
...
from src.data_gen.utils.mp_feature_extractors.mp_segmenter import MediapipeSegmenter, encode_segmap_mask_to_image, decode_segmap_mask_from_image, job_cal_seg_map_for_image
...
from src.data_gen.utils.process_video.split_video_to_imgs import extract_img_job
...
if __name__ == '__main__':
    ...
    parser.add_argument("--vid_dir", default='data/raw/videos/test4.mp4')
    ...
    parser.add_argument("--force_single_process", default=True, action="store_true") # turn this on if you find multi-process does not work on your environment
