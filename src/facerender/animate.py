...
class AnimateFromCoeff():
    ...
    def generate(self, x, video_save_dir, pic_path, crop_info, restorer_model, enhancer_model, enhancer_region, bg_img='', ppt_img_folder='', speeches_duration_csv_path=''):
        ...
        tmp_path, new_audio_path = paste_pic(path, pic_path, crop_info, new_audio_path,
                                             ...
                                             enhancer_region, bg_img, ppt_img_folder, speeches_duration_csv_path)
